      ...
      <MDBContainer className="py-5">
        <ul className="timeline-with-icons">
          <li className="timeline-item mb-5">
            ...
            <h5 className="fw-bold"> B.Sc.(Hons.) in Information Technology</h5>
            <p className="text-muted mb-2 fw-bold">University of Moratuwa</p>
          ...
          <li className="timeline-item mb-5">
            ...
            <h5 className="fw-bold">G.C.E Advanced Level Examination</h5>
          ...
          <li className="timeline-item mb-5">
            ...
            <h5 className="fw-bold"> G.C.E Ordinary Level Examination</h5>
            <p className="text-muted mb-2 fw-bold">
              Panadura Balika Maha Vidyalaya
            </p>
